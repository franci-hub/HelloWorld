...
public class NewJFrame extends javax.swing.JFrame { 
    ...
    private void initComponents() {
        ...
        patientMenu.setText("Student");

        patientItem.setText("Student Panel");
        ...
        assignMenuItem.setText("Assign patients to instructor");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        Hospital.getInstance().getStudents().add(s);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        Hospital.getInstance().getStudents().remove(obj);
    ...
    private void instructorItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instructorItemActionPerformed
        instructorPanel.setVisible(true);//instructorItem event that will set true the panel for the instructor and false for the patient & assignPanel
...
//        }
        ...
        for (int i=0;i<selectedIndices.length;i++)
        {
            ...
            in.getStudents().add((Patient)nObj);//add sdutents to instructor
        }
       ...
       Iterator patients =  in.getStudents().iterator();
...
//        jList5.setModel(dm3);
    ...
    private void updateBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtn1ActionPerformed
        ...
        Hospital.getInstance().getInstructors().remove(obj);
        ...
        Hospital.getInstance().getInstructors().add(in);
